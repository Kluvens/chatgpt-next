...
const Home: React.FC = () => {
  const [chats, setChats] = useState<Chat[]>([
    ...
    {
      id: "third",
      message: "very very very nice",
      response: {
        response:
          "The sun dipped below the horizon, casting a golden hue across the tranquil lake. The gentle rustling of leaves and the distant call of a loon added to the serene ambiance, creating a perfect backdrop for reflection. As the sky transitioned from vibrant oranges and pinks to deeper purples and blues, the first stars began to twinkle, mirroring the shimmering water below. It was a moment of pure magic, where time seemed to stand still, allowing one to fully appreciate the beauty and calm of nature",
        audioUrl: "",
        isResponseBad: false,
      },
    },
    {
      id: "fourth",
      message: "very very very very nice",
      response: {
        response:
