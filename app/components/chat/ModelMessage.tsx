...
const ModelMessage: React.FC<ModelMessageProps> = ({
  response,
  regenerate,
}) => {
  ...
  const handleMarkBadClick = () => {
    setIsResponseBad(true);
  };
                ...
                <div className="absolute mt-1 flex gap-3 hidden group-hover/conversation-turn:flex z-10">
                  <div className="items-center justify-start rounded-xl p-1 z-10 -mt-1 bg-token-main-surface-primary md:absolute md:border md:border-token-border-light">
                    <div className="flex items-center">
                      <span className="">
                        <button
                          className="rounded-lg token-text-secondary hover:token-surface-secondary"
                          onClick={playAudio}
                        >
                      ...
                      <span className="">
                        ...
                        >
                          <span className="flex h-[30px] w-[30px] items-center justify-center">
                            {copied ? <MessageTickIcon /> : <MessageCopyIcon />}
                          </span>
                        </button>
                      </span>
                      <span className="">
