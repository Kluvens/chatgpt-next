  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M6.006 5.5a.8.8 0 0 0 .19.21c.229.193.62.412 1.19.616C8.52 6.731 10.152 7 12 7c1.85 0 3.48-.27 4.613-.674.571-.204.962-.423 1.192-.617a.8.8 0 0 0 .189-.209.8.8 0 0 0-.19-.21c-.229-.193-.62-.412-1.19-.616C15.48 4.269 13.848 4 12 4c-1.85 0-3.48.27-4.613.674-.571.204-.962.423-1.192.617a.8.8 0 0 0-.189.209M18 7.917a8 8 0 0 1-.714.293c-1.4.5-3.27.79-5.286.79-2.017 0-3.886-.29-5.286-.79A8 8 0 0 1 6 7.917v4.07c.008.02.04.08.143.175.177.166.489.363.963.557.942.385 2.324.674 3.945.757a1 1 0 1 1-.102 1.997c-1.772-.09-3.39-.408-4.6-.903A8 8 0 0 1 6 14.417v4.07c.008.02.04.08.143.175.177.166.489.363.963.557.942.385 2.324.674 3.945.757a1 1 0 1 1-.102 1.997c-1.772-.09-3.39-.408-4.6-.903-.601-.245-1.153-.555-1.57-.945-.42-.39-.779-.938-.779-1.625v-13c0-.754.43-1.337.905-1.737.479-.405 1.113-.724 1.809-.973C8.114 2.29 9.984 2 12 2c2.017 0 3.886.29 5.286.79.696.249 1.33.568 1.81.973.474.4.904.983.904 1.737V10a1 1 0 1 1-2 0zM17.5 13a1 1 0 0 1 1 1v.67c.351.125.672.312.95.55l.58-.336a1 1 0 1 1 1 1.732l-.58.335a3 3 0 0 1 0 1.098l.58.335a1 1 0 0 1-1 1.732l-.58-.336a3 3 0 0 1-.95.55V21a1 1 0 1 1-2 0v-.67a3 3 0 0 1-.95-.55l-.581.336a1 1 0 0 1-1-1.732l.581-.336a3 3 0 0 1 0-1.096l-.58-.336a1 1 0 1 1 1-1.732l.58.336c.278-.238.599-.425.95-.55V14a1 1 0 0 1 1-1m-.876 4.017.01-.017.01-.017a1 1 0 0 1 1.722.017l.008.014a1 1 0 0 1-.02 1.006 1 1 0 0 1-1.73-1.003"
        clipRule="evenodd"
      ></path>
    </svg>
  );
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M12 17.25c-.274 0-.681.137-1.318.731a1 1 0 1 1-1.364-1.462c.792-.74 1.67-1.269 2.682-1.269s1.89.53 2.682 1.269a1 1 0 0 1-1.364 1.462c-.637-.594-1.044-.731-1.318-.731"
        clipRule="evenodd"
      ></path>
      <path
        fill="currentColor"
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M5.5 4.914 4.293 6.121A1 1 0 0 0 4 6.828v10.12l1.5-2.25zM7.035 16l-2 3h13.93l-2-3zM18.5 14.697l1.5 2.25V6.437a1 1 0 0 0-.36-.768l-1.14-.95zm-2-.697V4h-9v10zM4.707 2.879A3 3 0 0 1 6.828 2h10.448a3 3 0 0 1 1.92.695l1.725 1.437A3 3 0 0 1 22 6.437V18a3 3 0 0 1-3 3H5a3 3 0 0 1-3-3V6.828a3 3 0 0 1 .879-2.12z"
        clipRule="evenodd"
      ></path>
      <path
        fill="currentColor"
        d="M12.63 5.936c.067-.36-.29-.592-.477-.311L9.567 9.497c-.153.228-.026.58.209.58h1.967l-.373 1.987c-.067.36.29.592.477.311l2.587-3.872c.152-.228.025-.58-.21-.58h-1.967z"
      ></path>
    </svg>
  );
};
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M7 5a3 3 0 013-3h9a3 3 0 013 3v9a3 3 0 01-3 3h-2v2a3 3 0 01-3 3H5a3 3 0 01-3-3v-9a3 3 0 013-3h2zm2 2h5a3 3 0 013 3v5h2a1 1 0 001-1V5a1 1 0 00-1-1h-9a1 1 0 00-1 1zM5 9a1 1 0 00-1 1v9a1 1 0 001 1h9a1 1 0 001-1v-9a1 1 0 00-1-1z"
        clipRule="evenodd"
      ></path>
    </svg>
  );
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M9 12.707l-2.293-2.293a1 1 0 00-1.414 1.414l3 3a1 1 0 001.414 0l7-7a1 1 0 00-1.414-1.414L9 12.707z"
        clipRule="evenodd"
      ></path>
    </svg>
  );
...
export const DownArrow = () => {
  return (
    <svg
      ...
      fill="none"
      viewBox="0 0 24 24"
      className="icon-md token-text-tertiary"
    >
      <path
        fill="currentColor"
        fillRule="evenodd"
...
export const SpeechRadioPlayIcon = () => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export const GoogleDriveIcon = () => {
  return (
    ...
    >
      <path
        fill="#0066DA"
        d="m3.511 18.427.882 1.535c.183.323.447.576.756.761l3.15-5.492H2c0 .357.092.715.275 1.038z"
      ></path>
      <path
        fill="#00AC47"
        d="M12 8.77 8.85 3.276c-.31.184-.574.438-.757.761L2.274 14.192c-.18.316-.275.674-.275 1.039h6.3z"
      ></path>
      <path
        fill="#EA4335"
        d="M18.85 20.723c.308-.185.572-.438.755-.761l.367-.635 1.752-3.058c.184-.323.275-.68.275-1.038h-6.3l1.34 2.654z"
      ></path>
      <path
        fill="#00832D"
        d="m11.998 8.77 3.15-5.493A2 2 0 0 0 14.118 3H9.878c-.367 0-.722.104-1.03.277z"
      ></path>
      <path
        fill="#2684FC"
        d="M15.698 15.23h-7.4l-3.15 5.493c.31.185.665.277 1.031.277h11.638a2.1 2.1 0 0 0 1.031-.277z"
      ></path>
      <path
        fill="#FFBA00"
        d="m18.815 9.115-2.91-5.077a2.1 2.1 0 0 0-.756-.761L12 8.769l3.7 6.462h6.289c0-.358-.092-.716-.275-1.039z"
      ></path>
    </svg>
  );
};
...
export const OneDriveIcon = () => {
  return (
    ...
    >
      <path
        fill="#0364B8"
        d="m7.824 7.353 3.849 2.305 2.293-.965a3.7 3.7 0 0 1 1.728-.295A5.73 5.73 0 0 0 5.358 6.67l.058-.001a4.56 4.56 0 0 1 2.408.683"
      ></path>
      <path
        fill="#0078D4"
        d="M7.824 7.353a4.56 4.56 0 0 0-2.407-.683l-.059.001a4.582 4.582 0 0 0-3.701 7.202l3.394-1.428 1.508-.635 3.36-1.414 1.754-.738z"
      ></path>
      <path
        fill="#1490DF"
        d="M15.694 8.398a3.71 3.71 0 0 0-1.727.295l-2.294.965.665.398 2.18 1.306.95.57 3.253 1.947a3.725 3.725 0 0 0-3.027-5.481"
      ></path>
      <path
        fill="#28A8EA"
        d="m15.47 11.932-.952-.57-2.18-1.306-.665-.398-1.754.738-3.36 1.414-1.508.634-3.394 1.429a4.58 4.58 0 0 0 3.76 1.963h10.026a3.72 3.72 0 0 0 3.278-1.957z"
      ></path>
    </svg>
  );
};

export const ToastTickIcon = () => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export const ChatInputGeneratingIcon = () => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
